...
public class AnswerData extends TriviaDAO {
	...
	/**
	 * Returns a Map of Answer instances for all answers relating to a given
	 * question ID.
	 * 
	 * @param int questionId - The ID of the question to get answers for.
	 * @return HashMap<Integer, Answer> - A map of Answer instances, indexed by
	 *         answer ID.
	 */
	public HashMap<Integer, Answer> getAnswersByQuestionId(int questionId) {
		SQLiteDatabase db = this.getReadableDatabase();

		Cursor cursor = db.query(TABLE_NAME, selectFields, QUESTION_ID + "="
