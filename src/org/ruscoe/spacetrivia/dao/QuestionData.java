...
/**
 * Extends TriviaDAO, providing methods to access data specific to trivia
...
public class QuestionData extends TriviaDAO {
	...
	private String[] selectFields = { _ID, CATEGORY_ID, DIFFICULTY, TEXT,
			DESCRIPTION };
	...
	/**
	 * Returns a Map of Question instances for all questions relating to a given
	 * category ID.
	 * 
	 * @param int categoryId - The ID of the category to get questions for.
	 * @return HashMap<Integer, Question> - A map of Question instances, indexed
	 *         by question ID.
	 */
