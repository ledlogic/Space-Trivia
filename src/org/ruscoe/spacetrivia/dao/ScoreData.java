...
/**
 * Extends TriviaDAO, providing methods to access data specific to trivia scores
 * in the application.
 * 
 * @author Dan Ruscoe
 */
public class ScoreData extends TriviaDAO {
	...
	private String[] selectFields = { CATEGORY_ID, QUESTIONS_ANSWERED,
			CORRECT_ANSWERS };
	...
	public List<Score> getScores() {
		...
		Cursor cursor = db.query(TABLE_NAME, selectFields, null, null, null,
				null, null);
	...
	/**
	 * Returns a Map of Scores instances for all trivia category scores, indexed
	 * by category ID.
	 * 
	 * @return HashMap<Integer, Scores> - A map of Score instances, indexed by
	 *         category ID.
	 */
	 ...
	 * @return Score - The Score instance for the given category ID. May be null
	 *         if no score has been logged.
	 */
	public Score getScoreByCategoryId(int categoryId) {
		SQLiteDatabase db = this.getReadableDatabase();

		Cursor cursor = db.query(TABLE_NAME, selectFields, CATEGORY_ID + "="
	 ...
	 * 
	 * @param Score
	 *            score - The Score instance to save.
	 */
	public void saveScore(Score score) {
		...
		int affectedRows = db.update(TABLE_NAME, values, CATEGORY_ID + "='"
				+ score.getCategoryId() + "'", null);
	 ...
	 * 
	 * @param Cursor
	 *            cursor - A Cursor instance resulting from a query on the
