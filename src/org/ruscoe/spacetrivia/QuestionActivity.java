...
/**
 * Displays the current trivia question during a trivia round.
 * 
 * @author Dan Ruscoe
 */
public class QuestionActivity extends Activity {
	...
	/**
	 * Click handler for answer option buttons. Determines the result of the
	...
	public void answerButtonClickHandler(View v) {
		...
		if (answer != null) {
			...
			if (answer.isCorrect()) {
				...
				SoundService.playButtonClickSuccess();
			} else {
				v.setBackgroundResource(R.drawable.answer_button_incorrect);

				SoundService.playButtonClickFailure();
			}
